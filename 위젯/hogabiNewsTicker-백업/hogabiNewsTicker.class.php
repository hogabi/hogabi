<?php
	...
	**/
    ...
    class hogabiNewsTicker extends WidgetHandler {
        ...
        /**
         * @brief 댓글 목록을 추출하여 hogabiNewsTickerItem으로 return
         **/
        ...
        function _getDocumentItems($args){
            ...
            if(count($document_srl_list)) {
                foreach($document_srl_list as $key => $val) {
					...
					$output = executeQuery('widgets.hogabiNewsTicker.getNewestDocument', $obj);
        ...
        function _getImageItems($args) {
            ...
            foreach($tmp_document_list as $oDocument){
                ...
                $content_item = new hogabiNewsTickerItem($browser_title);
        ...
        function _getRssItems($args){
            ...
            if($xml_doc->rss) {
                ...
                foreach ($items as $key => $value) {
                    ...
                    $content_item = new hogabiNewsTickerItem($rss->title);
